...
-- Carry MSID through sign-up alongside the rest of the 201 file.
...
begin
  ...
  values (
    ...
    'agent', 'pending', nullif(meta->>'employeeEid', '')
  )
  ...
  if coalesce(meta->>'lastName', '') <> ''
    ...
    insert into public.employee_profiles (
      user_id, employee_eid, msid, last_name, first_name, middle_name, position,
