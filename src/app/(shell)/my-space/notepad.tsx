...
export function Notepad({ initial }: { initial: string | null }) {
  ...
  return (
    <section className="flex flex-col border-2 border-ink bg-surface md:col-span-2" aria-label="Notepad">
      <div className="flex items-center justify-between gap-2.5 border-b-2 border-ink px-5 py-4">
        <div className="flex items-center gap-2.5">
          <PadIcon />
          <div>
            <h2 className="text-[15px] font-bold text-ink">Notepad</h2>
            <p className="mt-0.5 text-[11px] font-semibold tracking-[0.08em] text-muted uppercase">
              {/* Said plainly, because it is the one box on this page that
