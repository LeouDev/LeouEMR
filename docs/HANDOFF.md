...
- **The nightly integrity workflow** (`.github/workflows/integrity.yml`,
  ...
  start. The 33 development items the separation sweep closed for active
  agents (17 Sep) were reopened by the owner and replayed by a September
  re-import (notes bullet "The nightly integrity run was red").
